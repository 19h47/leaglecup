 ...
 */
function acf_bloc_gutenberg_member_posts() {
	...
	$settings = array(
		...
		'render_callback' => 'acf_bloc_gutenberg_member_posts_callback',
		'category'        => 'widgets',
		'icon'            => 'groups',
...
add_action('acf/init', 'acf_bloc_gutenberg_member_posts');
 ...
 * @return Timber
 */
function acf_bloc_gutenberg_member_posts_callback( $block, $content = '', $is_preview = false ) {
